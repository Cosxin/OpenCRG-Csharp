...
using System.Threading.Tasks;
    ...
    static class OpenCRG
    {
        ...
        */
        ...
        public extern static string crgGetReleaseInfo();
        /**
        ...
        */
        [DllImport("OpenCRG.dll", CallingConvention = CallingConvention.Cdecl)]
        public extern static int crgIsNan(ref double dValue);
        ...
        */
        [DllImport("OpenCRG.dll", CallingConvention = CallingConvention.Cdecl)]
        public extern static int crgIsNanf(ref float dValue);
        /* ====== METHODS in crgMsg.c ====== */
        /**
